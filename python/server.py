...
models = {
    # "deepseek-prover-sft": DecoderOnlyTransformer(
    #     "deepseek-ai/DeepSeek-Prover-V1.5-SFT",
    #     num_return_sequences=32,
    #     max_length=1024,
    # ),
    # "deepseek-prover-rl": DecoderOnlyTransformer(
    #     "deepseek-ai/DeepSeek-Prover-V1.5-RL",
    #     num_return_sequences=32,
    #     max_length=1024,
    # ),
    # "Goedel-prover-rl": DecoderOnlyTransformer(
    #     "Goedel-LM/Goedel-Prover-SFT",
    #     num_return_sequences=32,
    #     max_length=1024,
    # ),
    "local-deepseek": OllamaRunner(
        model="hf.co/mradermacher/DeepSeek-Prover-V1.5-RL-GGUF",
        temperature=0.9,
        max_tokens=1024,
        top_p=0.9,
        frequency_penalty=0,
